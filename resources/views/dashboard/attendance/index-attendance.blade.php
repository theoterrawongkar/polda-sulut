<x-app-layout>
    ...
    <section class="container mx-auto p-6 bg-white rounded-lg">
        ...
        <div class="flex flex-col md:flex-row justify-end items-center mb-4 space-y-2 md:space-y-0">
            ...
            <form action="{{ route('dashboard.attendances.indexEmployeeAttendance') }}" method="GET">
                ...
                <tbody>
                    @forelse ($employees as $employee)
                        <tr class="border-t hover:bg-blue-100 transition duration-200">
                            ...
                            <td class="py-3 px-2 text-center">{{ $employee->nrp }}</td>
                            ...
                            <td class="py-3 px-2 text-center whitespace-nowrap">
                                <div class="flex justify-center items-center space-x-1">
                                    <a href="{{ route('dashboard.attendances.showEmployeeAttendance', $employee->nrp) }}"
