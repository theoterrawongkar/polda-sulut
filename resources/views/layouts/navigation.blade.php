    ...
    <nav class="flex-1 p-4 space-y-2 font-light">
        ...
        <div>
            ...
            <a href="{{ route('dashboard.attendances.create') }}"
                class="{{ Request::routeIs('dashboard.attendances.create') ? 'bg-gray-200 text-black animate-pulse' : 'text-white animate-none' }} flex gap-4 px-4 py-1.5 rounded hover:bg-gray-200 hover:text-gray-900">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            @can('manage-attendance')
                <a href="{{ route('dashboard.attendances.indexEmployeeAttendance') }}"
                    class="{{ Request::routeIs('dashboard.attendances.indexEmployeeAttendance') ? 'bg-gray-200 text-black animate-pulse' : 'text-white animate-none' }} flex gap-4 px-4 py-1.5 rounded hover:bg-gray-200 hover:text-gray-900">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M9 8.25H7.5a2.25 2.25 0 0 0-2.25 2.25v9a2.25 2.25 0 0 0 2.25 2.25h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25H15M9 12l3 3m0 0 3-3m-3 3V2.25" />
